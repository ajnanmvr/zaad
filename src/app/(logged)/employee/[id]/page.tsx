        ...
        <div className="overflow-hidden rounded-lg bg-white shadow-default dark:bg-boxdark">
          <div className="px-6 py-8 sm:p-10">
            <div className="flex items-start justify-between">
              <div>
                <h2 className="text-3xl font-bold capitalize text-black dark:text-white">{employee?.name}</h2>
                <Link
                  href={`/company/${employee?.company?._id}`}
                  className="mb-8 capitalize text-gray-600 dark:text-gray-400"
                >
            ...
            <div className="mt-5 grid min-h-44 grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                <h3 className="mb-2 text-lg font-semibold text-black dark:text-white">Employee Details</h3>
                <ul className="grid gap-x-4 sm:grid-cols-2">
                  {employee?.emiratesId && (
                    <li>
                      Emirates ID:
                      <span className="mx-1 break-words font-medium">{employee.emiratesId}</span>
                    </li>
                  )}
                  {employee?.nationality && (
                    <li>
                      Nationality:
                      <span className="mx-1 break-words font-medium">{employee.nationality}</span>
                    </li>
                  )}
                  {employee?.phone1 && (
                    <li>
                      Phone 1:
                      <span className="mx-1 break-words font-medium">{employee.phone1}</span>
                    </li>
                  )}
                  {employee?.phone2 && (
                    <li>
                      Phone 2:
                      <span className="mx-1 break-words font-medium">{employee.phone2}</span>
                    </li>
                  )}
                  {employee?.email && (
                    <li>
                      Email:
                      <span className="mx-1 break-words font-medium">{employee.email}</span>
                    </li>
                  )}
                  {employee?.designation && (
                    <li>
                      Designation:
                      <span className="mx-1 break-words font-medium">{employee.designation}</span>
                    </li>
                  )}
                  {employee?.remarks && (
                    <li>
                      Remarks:
                      <span className="mx-1 break-words font-medium">{employee.remarks}</span>
                    </li>
                  )}
                </ul>
              </div>
            ...
            {employee?.documents?.length !== 0 && (
              <div className="mt-8">
                <h3 className="mb-2 text-xl font-semibold text-black dark:text-white">Documents</h3>
