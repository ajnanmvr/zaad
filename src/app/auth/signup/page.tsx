...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | ZaadAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page ZaadAdmin Dashboard Template",
  // other metadata
};
